...
util.inherits(Flow, Emitter);


/**
 * Fired when the Flow is close
 *
 * @event
 * @name close
 * @memberOf Flow
...
function Flows(numsOrObjects) {
  if (!(this instanceof Flows)) {
    return new Flows(numsOrObjects);
  }
...
Flows.prototype = Object.create(Collection.Emitter.prototype, {
  constructor: {
    value: Flows
  }
});
...
Collection.installMethodForwarding(
  Flows.prototype, Flow.prototype
);

// Assign Flows Collection class as static "method" of Flow.
